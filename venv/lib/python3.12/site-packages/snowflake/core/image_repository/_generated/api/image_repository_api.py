...
class ImageRepositoryApi(object):
    ...
    def create_image_repository(
        ...
        **kwargs
        ...
        >>> future = api.create_image_repository(database, var_schema, image_repository, create_mode, async_req=True)
    ...
    def create_image_repository_with_http_info(
        ...
        >>> future = api.create_image_repository_with_http_info(database, var_schema, image_repository, create_mode, async_req=True)
        >>> result = future.result()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        Annotated[
            ...
            name: Annotated[
                ...
                Field(strict=True,
                      description="Identifier (i.e. name) for the resource.")],
            async_req: bool = False,
            **kwargs) -> Union[ImageRepository, Future[ImageRepository]]:
        ...
            ...
            Field(
                ...
                Field(strict=True,
                      description="Identifier (i.e. name) for the resource.")],
                               **kwargs) -> Union[
                                   ImageRepository,
                                   Future[ImageRepository]]:  # noqa: E501
    ...
    def list_image_repositories(
        ...
        Annotated[
            ...
            async_req: Literal[False] = False,
            **kwargs) -> Iterable[ImageRepository]:
        ...
    ...
    def list_image_repositories(
        ...
        Annotated[
            ...
            async_req: Literal[True] = True,
            **kwargs) -> Future[Iterable[ImageRepository]]:
        ...
    ...
    def list_image_repositories(
        ...
        **kwargs
    ) -> Union[Iterable[ImageRepository],
               Future[Iterable[ImageRepository]]]:  # noqa: E501
        ...
        Annotated[
            ...
            name: Annotated[
                ...
                Field(strict=True,
                      description="Identifier (i.e. name) for the resource.")],
            async_req: bool = False,
            **kwargs) -> Union[Iterable[Image], Future[Iterable[Image]]]:
        ...
            ...
            Field(
                ...
                Field(strict=True,
                      description="Identifier (i.e. name) for the resource.")],
                                  **kwargs) -> Union[
                                      Iterable[Image],
                                      Future[Iterable[Image]]]:  # noqa: E501
    ...
    def delete_image_repository_with_http_info(
        ...
        >>> future = api.delete_image_repository_with_http_info(database, var_schema, name, if_exists, async_req=True)
        >>> result = future.result()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
