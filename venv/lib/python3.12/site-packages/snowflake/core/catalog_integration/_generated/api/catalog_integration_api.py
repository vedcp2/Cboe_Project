...
class CatalogIntegrationApi(object):
    ...
    def create_catalog_integration_with_http_info(
        ...
        >>> future = api.create_catalog_integration_with_http_info(catalog_integration, create_mode, async_req=True)
        >>> result = future.result()
        :param catalog_integration: (required)
        :type catalog_integration: CatalogIntegration
        :param create_mode: Query parameter allowing support for different modes of resource creation. Possible values include: - `errorIfExists`: Throws an error if you try to create a resource that already exists. - `orReplace`: Automatically replaces the existing resource with the current one. - `ifNotExists`: Creates a new resource when an alter is requested for a non-existent resource.
    ...
    def fetch_catalog_integration(
            ...
            name: Annotated[
                ...
                Field(strict=True,
                      description="Identifier (i.e. name) for the resource.")],
            async_req: Literal[True] = True,
            **kwargs) -> Future[CatalogIntegration]:
        ...
    ...
    def fetch_catalog_integration(
            ...
            name: Annotated[
                ...
                Field(strict=True,
                      description="Identifier (i.e. name) for the resource.")],
            async_req: bool = False,
            **kwargs) -> Union[CatalogIntegration, Future[CatalogIntegration]]:
        ...
    ...
    def fetch_catalog_integration(
        self, name: Annotated[
            ...
            Field(strict=True,
                  description="Identifier (i.e. name) for the resource.")],
        **kwargs
    ) -> Union[CatalogIntegration, Future[CatalogIntegration]]:  # noqa: E501
    ...
    def list_catalog_integrations(
        ...
        Annotated[
            ...
            async_req: Literal[False] = False,
            **kwargs) -> Iterable[CatalogIntegration]:
        ...
    ...
    def list_catalog_integrations(
        ...
        Annotated[
            ...
            async_req: Literal[True] = True,
            **kwargs) -> Future[Iterable[CatalogIntegration]]:
        ...
    ...
    def list_catalog_integrations(
        ...
        async_req: bool = False,
        **kwargs
    ) -> Union[Iterable[CatalogIntegration],
    ...
    def list_catalog_integrations(
        ...
        **kwargs
               ...
               Future[Iterable[CatalogIntegration]]]:  # noqa: E501
