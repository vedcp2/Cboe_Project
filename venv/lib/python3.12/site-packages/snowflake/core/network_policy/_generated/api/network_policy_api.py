...
class NetworkPolicyApi(object):
    ...
    def fetch_network_policy(
            ...
            name: Annotated[
                ...
                Field(strict=True,
                      description="Identifier (i.e. name) for the resource.")],
            async_req: bool = False,
            **kwargs) -> Union[NetworkPolicy, Future[NetworkPolicy]]:
        ...
    ...
    def fetch_network_policy(
            self, name: Annotated[
                ...
                Field(strict=True,
                      description="Identifier (i.e. name) for the resource.")],
            **kwargs
    ) -> Union[NetworkPolicy, Future[NetworkPolicy]]:  # noqa: E501
    ...
    def list_network_policies(self,
                              async_req: Literal[False] = False,
                              **kwargs) -> Iterable[NetworkPolicy]:
        ...

    @overload
    def list_network_policies(self,
                              async_req: Literal[True] = True,
                              **kwargs) -> Future[Iterable[NetworkPolicy]]:
        ...
    ...
    def list_network_policies(
        self, **kwargs
    ) -> Union[Iterable[NetworkPolicy],
               Future[Iterable[NetworkPolicy]]]:  # noqa: E501
