...
class GetModelsResponseModel():
    ...
    def _to_model(self):
        return GetModelsResponse(models=self.models, )

    @classmethod
    def _from_model(cls, model) -> GetModelsResponseModel:
        return GetModelsResponseModel(models=model.models, )

    def to_dict(self):
        """Creates a dictionary of the properties from a GetModelsResponse.
    ...
    def from_dict(cls, obj: dict) -> GetModelsResponseModel:
        """Creates an instance of GetModelsResponse from a dict.
