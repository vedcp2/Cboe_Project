...
class FunctionApi(object):
    ...
    def create_function_with_http_info(
        ...
        >>> future = api.create_function_with_http_info(database, var_schema, function, create_mode, async_req=True)
        >>> result = future.result()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
    ...
    def execute_function_with_http_info(
        ...
        >>> future = api.execute_function_with_http_info(database, var_schema, name, function_argument, async_req=True)
        >>> result = future.result()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
    ...
    def fetch_function(
        ...
        Annotated[
            ...
            name_with_args: Annotated[
                ...
                Field(description="Function's name with Args")],
            async_req: bool = False,
            **kwargs) -> Union[Function, Future[Function]]:
        ...
        ...
        Field(
            ...
            Field(
                ...
                Field(description="Function's name with Args")], **kwargs
                       ) -> Union[Function, Future[Function]]:  # noqa: E501
    ...
    def list_functions(
        ...
        Annotated[
            ...
            async_req: Literal[True] = True,
            **kwargs) -> Future[Iterable[Function]]:
        ...
    ...
    def list_functions(
        ...
        Annotated[
            ...
            async_req: bool = False,
            **kwargs) -> Union[Iterable[Function], Future[Iterable[Function]]]:
        ...
    ...
    def list_functions(
        ...
        **kwargs
    ) -> Union[Iterable[Function], Future[Iterable[Function]]]:  # noqa: E501
    ...
    def delete_function_with_http_info(
        ...
        >>> future = api.delete_function_with_http_info(database, var_schema, name_with_args, if_exists, async_req=True)
        >>> result = future.result()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
