...
class ComputePoolApi(object):
    ...
    def create_compute_pool_with_http_info(
        ...
        >>> future = api.create_compute_pool_with_http_info(compute_pool, create_mode, initially_suspended, async_req=True)
        >>> result = future.result()
        :param compute_pool: (required)
        :type compute_pool: ComputePool
        :param create_mode: Query parameter allowing support for different modes of resource creation. Possible values include: - `errorIfExists`: Throws an error if you try to create a resource that already exists. - `orReplace`: Automatically replaces the existing resource with the current one. - `ifNotExists`: Creates a new resource when an alter is requested for a non-existent resource.
    ...
    def create_or_alter_compute_pool(
        self, name: Annotated[
            ...
            Field(strict=True,
                  description="Identifier (i.e. name) for the resource.")],
        compute_pool: ComputePool, **kwargs
    ) -> Union[SuccessResponse, Future[SuccessResponse]]:  # noqa: E501
    ...
    def fetch_compute_pool(
            ...
            name: Annotated[
                ...
                Field(strict=True,
                      description="Identifier (i.e. name) for the resource.")],
            async_req: bool = False,
            **kwargs) -> Union[ComputePool, Future[ComputePool]]:
        ...
    ...
    def fetch_compute_pool(
            self, name: Annotated[
                ...
                Field(strict=True,
                      description="Identifier (i.e. name) for the resource.")],
            **kwargs) -> Union[ComputePool, Future[ComputePool]]:  # noqa: E501
    ...
    def list_compute_pools(
        ...
        Annotated[
            ...
            async_req: Literal[True] = True,
            **kwargs) -> Future[Iterable[ComputePool]]:
        ...
    ...
    def list_compute_pools(
        ...
        **kwargs
    ) -> Union[Iterable[ComputePool],
               Future[Iterable[ComputePool]]]:  # noqa: E501
