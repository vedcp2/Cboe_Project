...
class ExternalVolumeApi(object):
    ...
    def fetch_external_volume(
            ...
            name: Annotated[
                ...
                Field(strict=True,
                      description="Identifier (i.e. name) for the resource.")],
            async_req: bool = False,
            **kwargs) -> Union[ExternalVolume, Future[ExternalVolume]]:
        ...
    ...
    def fetch_external_volume(
        self, name: Annotated[
            ...
            Field(strict=True,
                  description="Identifier (i.e. name) for the resource.")],
        **kwargs
    ) -> Union[ExternalVolume, Future[ExternalVolume]]:  # noqa: E501
    ...
    def list_external_volumes(
        ...
        Annotated[
            ...
            async_req: Literal[False] = False,
            **kwargs) -> Iterable[ExternalVolume]:
        ...
    ...
    def list_external_volumes(
        ...
        Annotated[
            ...
            async_req: Literal[True] = True,
            **kwargs) -> Future[Iterable[ExternalVolume]]:
        ...
    ...
    def list_external_volumes(
        ...
        **kwargs
    ) -> Union[Iterable[ExternalVolume],
               Future[Iterable[ExternalVolume]]]:  # noqa: E501
