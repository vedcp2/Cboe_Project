...
class StreamApi(object):
    ...
    def create_stream_with_http_info(
        ...
        >>> future = api.create_stream_with_http_info(database, var_schema, stream, create_mode, copy_grants, async_req=True)
        >>> result = future.result()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
    ...
    def clone_stream(
        ...
        **kwargs
        ...
        >>> future = api.clone_stream(database, var_schema, name, target_database, target_schema, stream_clone, create_mode, copy_grants, async_req=True)
        >>> result = future.result()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
    ...
    def clone_stream_with_http_info(
        ...
        >>> future = api.clone_stream_with_http_info(database, var_schema, name, target_database, target_schema, stream_clone, create_mode, copy_grants, async_req=True)
        >>> result = future.result()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        Annotated[
            ...
            name: Annotated[
                ...
                Field(strict=True,
                      description="Identifier (i.e. name) for the resource.")],
            async_req: bool = False,
            **kwargs) -> Union[Stream, Future[Stream]]:
        ...
    ...
    def fetch_stream(self, database: Annotated[
        ...
        Field(
            ...
            Field(
                ...
                Field(strict=True,
                      description="Identifier (i.e. name) for the resource.")],
                     **kwargs) -> Union[Stream, Future[Stream]]:  # noqa: E501
    ...
    def list_streams(
        ...
        Annotated[
            ...
            async_req: bool = False,
            **kwargs) -> Union[Iterable[Stream], Future[Iterable[Stream]]]:
        ...
    ...
    def list_streams(
        ...
        **kwargs
    ) -> Union[Iterable[Stream], Future[Iterable[Stream]]]:  # noqa: E501
        ...
        >>> future = api.list_streams(database, var_schema, like, starts_with, show_limit, from_name, async_req=True)
        >>> result = future.result()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
    ...
    def list_streams_with_http_info(
        ...
        >>> future = api.list_streams_with_http_info(database, var_schema, like, starts_with, show_limit, from_name, async_req=True)
        >>> result = future.result()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
